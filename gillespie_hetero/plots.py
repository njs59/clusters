...
def final_step_plot(psi, simulation_max):
    n_max = np.max(psi)
...
def final_step_normalise_plot(psi, simulation_max):
    n_max = np.max(psi)
    # plots_number = simulation_max
    x = range(1,101)
    y_raw = psi[-1,:]
...
def final_step_mass_plot(psi, simulation_max):
    n_max = np.max(psi)
    # plots_number = simulation_max
    x = range(1,101)
    y_raw = psi[-1,:]
...
def final_step_mass_hist(psi, simulation_max, sim_num):
    n_max = np.max(psi)
    # plots_number = simulation_max
    x = range(1,101,5)
    y_raw = psi[-1,:]
