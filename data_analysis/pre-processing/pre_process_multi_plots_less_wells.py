...
for j in range(len(multi_dates)):
    ...
    for i in range(len(multi_well)):
        ...
        plt.savefig(basedir + 'clusters/data_analysis/pre-processing/INV_Mean_areas_' + 'multi' + '.png', dpi=300, bbox_inches="tight")
        # plt.show()
        # plt.clf()
        ...
        plt.savefig(basedir + 'clusters/data_analysis/pre-processing/INV_Number_clusters_' + 'multi' + '.png', dpi=300, bbox_inches="tight")
        # plt.show()
        # plt.clf()
        ...
        plt.savefig(basedir + 'clusters/data_analysis/pre-processing/INV_Total_3D_Number_cells_' + 'multi' + '.png', dpi=300, bbox_inches="tight")
        # plt.show()
        # plt.clf()
        ...
        plt.xlabel("time (hours)")
        # plt.title("Mean number of cells in a cluster")
        plt.savefig(basedir + 'clusters/data_analysis/pre-processing/INV_Mean_volume_cluster_' + 'multi' + '.png', dpi=300, bbox_inches="tight")
        # plt.show()
        # plt.clf()
        plt_num += 1
