...
for i in range(len(time_list)):
        ...
        for l in range(len(no_same_locs_index)): 
            ...
            if len(near_clus) == 0:
                ...
                if x_cen < 10 or x_cen > 1015 or y_cen < 10 or y_cen > 1334:
                    ...
                    df_step.iloc[index_of_interest-1,4] = 'Edge Appearance type 1'
                    
                else:
                    # Cluster has just appeared (type 1 is no neaarby clusters at all)
                    df_step.iloc[index_of_interest-1,4] = 'Appearance type 1'
                    ...
                    if max_near_non_assigned_size < new_cluster_size:  
                        ...
                        if percent_diff < 20:
                            ...
                            # Cluster appeared at edge (type 2 is nearby non-assigned clusters)
                                df_step.iloc[index_of_interest-1,4] = 'Edge Appearance type 2'                    
                            else:
    ...
    df_step_csv_name_list = basedir, exp_type, 'post_processing_output/', exp_date, '/', well_loc, 't', time_list[i], 'c2', '_post_processing', '.csv'
